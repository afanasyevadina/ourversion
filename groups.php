			...
			<div id="add">
				<form action="groups/savegroup.php" method="post" id="groupform" class="addform small">
					...
					<div>						
						...
						<input type="number" name="s1" min="0" id="s1">
					...
					<div>
						...
						<input type="number" name="s2" min="0" id="s2">
					...
					<div>
						...
						<input type="number" name="s3" min="0" id="s3">
					...
					<div>
						...
						<input type="number" name="s4" min="0" id="s4">
					...
					<div>
						...
						<input type="number" name="s5" min="0" id="s5">
					...
					<div>
						...
						<input type="number" name="s6" min="0" id="s6">
					...
					<div>
						...
						<input type="number" name="s7" min="0" id="s7">
					...
					<div>
						...
						<input type="number" name="s8" min="0" id="s8">
